...
video_url = ""
modified_time = ""
class TimeOfIndia(scrapy.Spider):
    name="page_timesofindia"
    start_urls=[
        'https://timesofindia.indiatimes.com/videos/international',
        'https://timesofindia.indiatimes.com/videos/business',
        'https://timesofindia.indiatimes.com/videos/auto',
        'https://timesofindia.indiatimes.com/videos/tech',
        'https://timesofindia.indiatimes.com/videos/education',
        'https://timesofindia.indiatimes.com/videos/amazing-but-true',
    ...
    def parse(self, response):
        ...
        if ("education" in category):
            category = "education"
        if ("amazing-but-true" in category):
            category = "amazing"
        if("news" in category ) :
            category = "news"
        links = hxs.xpath("//figure[@class = 'D3Oi9']/a/@href").extract()
        # print(lang,category)
        # links = hxs.xpath("//div[@class = '_1LBiG']/div/a/@href").extract()
        # print(len(links))
        links = links[0:5]
        # print(len(links))
