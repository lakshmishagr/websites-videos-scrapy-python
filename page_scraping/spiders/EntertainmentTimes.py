...
class EntertainmentTimes(scrapy.Spider):
    name="page_entertainmenttimes"
    start_urls=[
        'https://timesofindia.indiatimes.com/videos/entertainment/hindi',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/kannada',
        'https://timesofindia.indiatimes.com/videos/entertainment/hollywood',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/tamil',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/telugu',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/malayalam',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/bangla',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/marathi',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/gujarati',
        'https://timesofindia.indiatimes.com/videos/entertainment/regional/bhojpuri'
        # 'https://timesofindia.indiatimes.com/etimes/videos',
    ...
    def parse(self, response):
        ...
        links = links[0:15] #reduced to 10 for reduce un wanted updates
        for link in links:
            url = domain + link
