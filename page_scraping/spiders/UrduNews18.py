...
#
# class UrduNews18(scrapy.Spider):
#     name="page_urdunews"
#     start_urls=[
#         'https://urdu.news18.com/videos/north-india/',
#         'https://urdu.news18.com/videos/east-india/',
#         'https://urdu.news18.com/videos/central-india/',
#         'https://urdu.news18.com/videos/west-india/',
#         'https://urdu.news18.com/videos/south-india/'
#         ]
#     user_agent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36"
#     def parse(self, response):
#         hxs = Selector(response)
#         links = hxs.xpath("//ul[@id = 'pnv']/li/a/@href").extract()
#         print("URDUNEWS Started")
#         for link in links:
#             url = link
...
#             try:
#                 video_url = response.xpath('//script[contains(., "var video_src")]/text()').re('var video_src	+= "(.+)"')[0]
#                 try:
...
#                 "broadcaster" : "5d5b8cdf11857574e9d440d8",   #Not yet changed
