...
#
# class MarathiNews(scrapy.Spider):
#     name="page_marathinews"
#     start_urls=[
#         'https://lokmat.news18.com/category/video/'
#         ]
#     user_agent = "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/41.0.2227.0 Safari/537.36"
#     def parse(self, response):
#         hxs = Selector(response)
#         links = hxs.xpath("//div[@class = 'pht-list clearfix']/ul/li/div[@class = 'pht-img']/a/@href").extract()
#         print("MARATHINEWS started")
#         for link in links:
#             url = link
#             yield scrapy.Request(url, callback=self.parse_subpage)
#     def parse_subpage(self, response):
#         try:
#             global video_url, duration, description, image, video_keywords, modified_video_keywords
#             try:
...
#                 "broadcaster" : "5d5b8b7011857574e9d440d4",   #Not yet changed
